...
> Answer: The seasonal Mann-Kendall is the most appropriate trend analysis because it accounts for seasonality in Ozone which based on the plot of the time series there appears to be strong seasonality in the data.
...
> Answer: Based on the graph of mean monthly ozone concentrations over a 10 year period we cannot discern a clear trend in Ozone concentration over this time period. The data is significantly affected by seasonality with peaks and troughs in the data over each year. Additionally, a monotonic trend analysis was conducted using Mann-Kendall to account for the seasonality in the date. The trend analysis found the there was not a statistically significant trend in the data. We know this becasue from our statistical test we got a pvalue that was not statistically significant, < 0.05, of (0.16323).
