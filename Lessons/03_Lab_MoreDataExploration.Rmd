...
```{r}
Durham_high_F <- c(51,59,48,47,44,39,36,37,36,49)
Durham_low_F <- c(38,38,40,34,29,28,19,23,29,30)
```
...
Durham_high_C <-Far_to_Cel(Durham_high_F)
Durham_high_C
Durham_low_C <-Far_to_Cel(Durham_low_F)
Durham_low_C
```
...
```{r}
Durham_10day_Temps <- data.frame(Durham_high_F,Durham_low_F,Durham_high_C,Durham_low_C)
colnames(Durham_10day_Temps)<-c("10-day High Temp F","10-day Low Temp F","10-day High Temp C","10-day Low Temp C")
```
...
```{r}
summary(Durham_10day_Temps)
sd(Durham_10day_Temps$`10-day High Temp F`)
sd(Durham_10day_Temps$`10-day Low Temp F`)
sd(Durham_10day_Temps$`10-day High Temp C`)
sd(Durham_10day_Temps$`10-day Low Temp C`)
```
